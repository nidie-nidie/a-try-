...
// MuJoCo 原生状态机轮子平衡参数：用于 --no-wheel-override 路径
...
#define MUJOCO_WHEEL_BALANCE_POS_KP (65.0f)
#define MUJOCO_WHEEL_BALANCE_VEL_KD (32.0f)
#define MUJOCO_WHEEL_BALANCE_DRIVE_KFF (100.0f)
#define MUJOCO_WHEEL_BALANCE_YAW_KP (1.2f)
#define MUJOCO_WHEEL_BALANCE_YAW_KD (0.25f)
#define MUJOCO_WHEEL_BALANCE_LIMIT (35.0f)
#define MUJOCO_JUMP_THRUST_FF (235.0f)
#define MUJOCO_JUMP_PITCH_TARGET (0.0f)
#define MUJOCO_JUMP_PITCH_OFFSET (-0.05f)
#define MUJOCO_JUMP_LANDING_PITCH_OFFSET (0.005f)
...
#define MUJOCO_JUMP_PITCH_WHEEL_LIMIT (50.0f)
#define MUJOCO_JUMP_TAKEOFF_YAW_KP (0.0f)
#define MUJOCO_JUMP_TAKEOFF_YAW_KD (1.2f)
#define MUJOCO_JUMP_TAKEOFF_YAW_LIMIT (2.5f)
...
#define MUJOCO_JUMP_COMPRESS_TARGET (0.15f)
...
#define MUJOCO_JUMP_LEG_SWING_OFFSET (-0.12f)
#define MUJOCO_JUMP_LEG_SWING_KP (30.0f)
#define MUJOCO_JUMP_LEG_SWING_KD (2.0f)
#define MUJOCO_JUMP_LEG_SWING_LIMIT (5.0f)
#define MUJOCO_JUMP_EXTEND_END_MARGIN (0.06f)
#define MUJOCO_JUMP_TUCK_KP (80.0f)
#define MUJOCO_JUMP_TUCK_KD (4.0f)
#define MUJOCO_JUMP_TUCK_TORQUE_LIMIT (25.0f)
#define MUJOCO_JUMP_PRELAND_CLEARANCE (0.30f)
#define MUJOCO_JUMP_PRELAND_L0 (0.34f)
#define MUJOCO_JUMP_PRELAND_RATE (1.20f)
...
#define MUJOCO_JUMP_BUFFER_L0 (0.22f)
#define MUJOCO_JUMP_BUFFER_RATE (0.30f)
#define MUJOCO_JUMP_BUFFER_SUPPORT_SCALE (0.85f)
#define MUJOCO_JUMP_BUFFER_PID_SCALE (0.65f)
#define MUJOCO_JUMP_BUFFER_HOLD_TIME (0.20f)
#define MUJOCO_JUMP_RECOVER_RATE (0.18f)
#define MUJOCO_JUMP_RECOVER_TIME (0.35f)
#define MUJOCO_JUMP_RECOVER_PITCH_RATE (1.5f)
#define MUJOCO_JUMP_LANDING_ROLL_F0_KP (80.0f)
#define MUJOCO_JUMP_LANDING_ROLL_F0_KD (6.0f)
#define MUJOCO_JUMP_LANDING_CONTACT_F0_KP (0.0f)
#define MUJOCO_JUMP_LANDING_BALANCE_F0_LIMIT (10.0f)
#define MUJOCO_JUMP_LANDING_ROLL_L0_KP (0.40f)
#define MUJOCO_JUMP_LANDING_ROLL_L0_KD (0.03f)
#define MUJOCO_JUMP_LANDING_BALANCE_L0_LIMIT (0.035f)
#define MUJOCO_JUMP_LANDING_CLEARANCE_L0_KP (2.0f)
#define MUJOCO_JUMP_LANDING_CLEARANCE_L0_RATE (3.0f)
#define MUJOCO_JUMP_LANDING_CLEARANCE_L0_LIMIT (0.045f)
