...
#define MUJOCO_JUMP_THRUST_FF (100.0f)
...
#define MUJOCO_JUMP_PITCH_WHEEL_KP (400.0f)
#define MUJOCO_JUMP_PITCH_WHEEL_KD (40.0f)
#define MUJOCO_JUMP_PITCH_WHEEL_LIMIT (35.0f)
...
#define MUJOCO_JUMP_LEG_SWING_OFFSET (-0.08f)
